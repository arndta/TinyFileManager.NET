...
namespace TinyFileManager.NET
{
    public partial class dialog : System.Web.UI.Page
    {
        ...
        public string strCurrLink;      // default.aspx?editor=.... for simplicity
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //setup current link
            strCurrLink = "default.aspx?type=" + this.strType + "&editor=" + this.strEditor + "&lang=" + this.strLang + "&profile=" + this.strProfile + "&targetId=" + Request["targetId"];
                ...
                default:    //just a regular page load
                    ...
                    foreach (string strF in arrFiles)
                    {
                        ...
                        if ((this.boolOnlyImage && this.objFItem.boolIsImage) || (this.boolOnlyVideo && this.objFItem.boolIsVideo) || (!this.boolOnlyImage && !this.boolOnlyVideo))
                        {
                            ...
                            this.objFItem.strDownFormOpen = "<form action=\"default.aspx?cmd=download&file=" + this.objFItem.strPath + "\" method=\"post\" class=\"download-form\">";
